...
$amer = $response->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <h5> Modifier la description du amer?</h5>

                            <label for="type">Type</label>
                            <select name="type" class="form-control">
                            <option value="<?= $amer['TYPE']?>">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nom" type="text" class="form-control" value="<?= $amer['NOM']?>"> 
                        </div>
                        <div class="form-group">
                            <label for="region">Région</label>
                            <input name="region" type="text" class="form-control" value="<?= $amer['REGION']?>"> 
                        </div>
